...
import Service_Providerform from "./Service_Providerform";
...
const headCells = [
    { id: 'fullName', label: 'Service Provider Name' },
    { id: 'city', label: 'Company Name' },
...
export default function Service_Provider() {
    ...
    const [records, setRecords] = useState(providerService.getAllProvider())
    ...
    const addOrEdit = (provider, resetForm) => {
        ...
        setOpenPopup(false)
        setRecords(providerService.getAllProvider())
        setNotify({
            isOpen: true,
