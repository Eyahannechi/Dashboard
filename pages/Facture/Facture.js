...
const headCells = [
    ...
    { id: 'city', label: 'Service Provider Name' },
...
export default function Facture() {
    ...
    const [records, setRecords] = useState(factureService.getAllFacture())
    ...
    const addOrEdit = (facture, resetForm) => {
        if (facture.id == 0)
        ...
        setOpenPopup(false)
        setRecords(factureService.getAllFacture())
        setNotify({
            isOpen: true,
